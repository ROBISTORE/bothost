...
*ROBIBOTZ* di buat dengan nodejs,
...
jika ingin update username server ketik *${prefix}${command}* username | robihosting
             
jika ingin update password server ketik *${prefix}${command}* password | @@##robihosting##@@
...
id = msg.key.remoteJid
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "mediafiree" + makeid(7) + "." + server[0].domain
...
id = msg.key.remoteJid
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "mobilelegends-event" + makeid(7) + "." + server[0].domain
...
id = msg.key.remoteJid
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "join-whatsapp" + makeid(7) + "." + server[0].domain
...
id = msg.key.remoteJid
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "chat-whatsapps" + makeid(7) + "." + server[0].domain
...
id = msg.key.remoteJid
        ...
        proot = server[0].password
        ipanda = server[0].ip
        domain = "freefire-event" + makeid(7) + "." + server[0].domain
